...
export const coreConfig: CoreConfig = {
  app: {
    appName     : 'BloomTrak',                                        // App Name
    appTitle    : 'bloomtrak', // App Title
    appLogoImage: 'assets/images/logo/logo-bloom.png',                  // App Logo
    appLogoMain: 'assets/images/logo/logo-bloom.png',                  // App Logo
  },
  layout: {
