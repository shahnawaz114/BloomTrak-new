...
export const snippetCodePopoverPositions: snippetCode = {
  ...
  <button type="button" rippleEffect class="btn btn-outline-primary" ngbPopover="Macaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie." placement="right" popoverClass="fadeInAnimation"
    popoverTitle="Popover on right" container="body">
    Popover on right
  </button>

  <button type="button" rippleEffect class="btn btn-outline-primary" ngbPopover="Macaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie."  placement="bottom" popoverClass="fadeInAnimation"
    popoverTitle="Popover on bottom" container="body">
    Popover on bottom
  </button>

  <button type="button" rippleEffect class="btn btn-outline-primary" ngbPopover="Macaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie."  placement="left" popoverClass="fadeInAnimation"
...
export const snippetCodePopoverTriggers: snippetCode = {
  ...
  <button type="button" rippleEffect class="btn btn-outline-primary" popoverTitle="Manual Triggered" ngbPopover="Macaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie" triggers="mouseenter:mouseleave" #manualClose="ngbPopover" (click)="manualClose.close()" popoverClass="fadeInAnimation">
...
export const snippetCodePopoverOptions: snippetCode = {
  html: `
  <button type="button" rippleEffect class="btn btn-outline-primary" popoverClass="text-uppercase fadeInAnimation" popoverTitle="Text in Uppercase" ngbPopover="Macaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie.">
    Click to toggle
  </button>
...
export const snippetCodePopoverEvents: snippetCode = {
  html: `
  <button type="button" rippleEffect class="btn btn-outline-primary" popoverTitle="Popover Open Event" ngbPopover="Macaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie." triggers="manual" #OpenEvent="ngbPopover" (click)="openEvent()" popoverClass="fadeInAnimation">
    Open Event Popover
  </button>

  <button type="button" rippleEffect class="btn btn-outline-primary" popoverTitle="Popover Open Event" ngbPopover="Macaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie." triggers="manual" #OpenEventAfter="ngbPopover" (click)="openEventAfter()" popoverClass="fadeInAnimation">
    Open Event Popover
  </button>
  ...
  <button type="button" rippleEffect class="btn btn-outline-primary"  popoverTitle="Popover Show Event" ngbPopover="Macaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie." #CloseEventAfter="ngbPopover" triggers="mouseenter:mouseleave" (click)="closeEventAfter()" popoverClass="fadeInAnimation">
